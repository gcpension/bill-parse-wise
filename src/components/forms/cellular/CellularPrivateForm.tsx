...
export const CellularPrivateForm = ({ selectedPlan, onClose }: CellularPrivateFormProps) => {
  ...
  const generatePDF = async () => {
    ...
    const content = [
      ...
      `טלפון ליצירת קשר: ${formData.phone}`,
      ...
      "",
      "אישורים:",
      formData.acceptOtpConfirmation ? "✓ מאושר קבלת OTP ב-SIM הנוכחי" : "✗ לא מאושר קבלת OTP",
      "",
      showHotMobileWarning ? "תזכורת: אם העברה ל-HOT Mobile - יש להתקשר לאחר הפעלת ה-SIM" : "",
      "",
      "ייפוי כוח:",
      ...
      "מסמכים מצורפים:",
      "✓ צילום ת.ז. בעל המנוי",
      formData.lastBill?.uploaded ? "✓ חשבונית אחרונה" : ""
    ];
