  ...
  const texts: Record<ServiceCategory, Record<CustomerType, PowerOfAttorneyText>> = {
    ...
    internet: {
      ...
      business: {
        ...
        full: `אנחנו, [שם התאגיד], ח.פ./ח.צ. [מס׳], ממנים את ${companyName} לביצוע ニתוק/חיבור שירותי אינטרנט ותשתיות עבור האתרים/קווים המפורטים, לרבות מסירת מזהים טכניים והשלמת הליכי הצטרפות. תוקף עד [תאריך פקיעה] או ביטול. מורשה חתימה: ___ ת.ז.: ___ תפקיד: ___ חתימה/חותמת: ___.`
      }
    },
    tv: {
      private: {
